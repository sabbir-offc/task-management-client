...
const AboutUsPage = () => {
  return (
    <div className="container mx-auto p-8">
      ...
      <p className="mb-6">
        Welcome to Tame Task, where we believe in simplifying task management to
        enhance your productivity and efficiency. Our platform is designed to
        empower individuals and teams in organizing, tracking, and completing
        tasks with ease.
      </p>
      ...
      <ul className="list-disc pl-6 mb-6">
        ...
        <li>Intuitive drag-and-drop functionality to update task statuses.</li>
